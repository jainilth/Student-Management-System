...
const navItems = [
    ...
    { name: "Attendance", path: "/faculty/attendance", icon: Activity },
    { name: "Grades & Results", path: "/faculty/grades", icon: ChartBar },
    { name: "Class Sessions", path: "/faculty/class-sessions", icon: Calendar },
    { name: "Projects", path: "/faculty/projects", icon: Layers },
    { name: "Study Materials", path: "/faculty/materials", icon: FileText },
    ...
    return (
        <aside className="hidden h-full min-h-0 w-[260px] shrink-0 bg-sidebar text-white md:block">
            <div className="flex h-full flex-col overflow-y-auto px-5 py-7">
                {/* Logo */}
                <Link href="/faculty" className="mb-10 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span className="block text-xs text-slate-400">Faculty Portal</span>
                    </div>
                </Link>
                ...
                {/* Bottom: current workload indicator */}
                <div className="mt-auto pt-6">
                    <div className="rounded-2xl bg-brand/10 p-4">
                        <p className="text-xs font-semibold text-brand">Current Workload</p>
                        <p className="mt-1 text-[11px] text-slate-400">6 subjects · 3 projects</p>
                        <div className="mt-3 h-1 rounded-full bg-white/10">
                            <div className="h-1 w-[72%] rounded-full bg-brand" />
                        </div>
                        <p className="mt-1 text-[10px] text-slate-500">72% capacity</p>
                    </div>
                </div>
            </div>
        </aside>
